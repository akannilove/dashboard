<?php
     ...
     // create a user validator calss to handle validation
          ...
          private function validateUsername(){
               ...
               if (empty($val)){
                    ...
                    if (!preg_match('/^[a-zA-Z0-9]{6,12}$/', $val)){
                         $this->addError('username', 'username must be at 6-12 characters and must be alphanumeric');
                    }
               }
          }
          ...
          private function validateEmail(){
               ...
               if (empty($val)){
                    ...
                    if (!filter_var($val, FILTER_VALIDATE_EMAIL)){
                         $this->addError('email', 'Please input a valid email address');
                    }
               }
          }
